...
- **サムネイル画像選択**: サムネイル生成時に、候補画像から2枚を選択できます。Finderで画像フォルダが自動的に開き、ターミナルで矢印キーを使って選択します。
- **画像フィルタリング**: Openverseから取得した画像（デフォルトで10枚）から、使用する画像を選択できます。
  - 画像取得後、Finderで画像フォルダが自動的に開きます
  - ターミナルにチェックボックスメニューが表示され、デフォルトで全画像が選択されています
  - **操作方法**: 
    - **左矢印キー**: チェックを外す
    - **右矢印キー**: チェックをつける
    - **上下矢印キー**: 選択肢を移動
    - **Enterキー**: 選択を確定
  - 選択された画像のみが動画生成に使用されます
